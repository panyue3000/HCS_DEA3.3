...
SET POPEST_LAYLA_1;
YEAR=YEAR+4;
IF YEAR NE 2022 THEN DELETE;
RUN;

DATA POPEST_2023;
SET POPEST_LAYLA_1;
YEAR=YEAR+4;
IF YEAR NE 2023 THEN DELETE;
RUN;
...
DATA POPEST_0;
length county $50.;
SET POPEST_LAYLA_1 POPEST_2019 POPEST_2020 POPEST_2021 POPEST_2022 popest_2023
    WONDER.popge18_county(RENAME=(SUM_POP=POP)) /*UP TO 2019*/
	WONDER_2021(RENAME=(SUM_POP=POP)) 
	WONDER_2022(RENAME=(SUM_POP=POP)) 
	WONDER_2023(RENAME=(SUM_POP=POP)) 
;
RUN;
